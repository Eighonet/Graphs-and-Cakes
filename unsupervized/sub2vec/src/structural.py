...
#    print(degreeDict)
    degree_keys = [k for k, v in degreeDict]
    labelDict = {}
    for node in degree_keys:
...
def structural_embedding(args):
    ...
    print("Structural output generated at the end of structural.py -- example embedding of the first subgraph:")    
